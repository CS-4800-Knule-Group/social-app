...
const Post = ({ post, openProfile, users, openPost }) => {
    ...
    return (
        <div key={post.postId} className='post-container' style={{ cursor: 'pointer'}}>
            ...
            <div className='rightside-post'>
                ...
                <div className='horizontal-flex' onClick={openPost}>
